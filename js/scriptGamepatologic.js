window.addEventListener('load', () => {
    ...
    function rollDice() {
      ...
      //face.style.backgroundImage = 'url("./image/dado3.PNG")';
      movePlayer(steps);
    }

    let cellToxic1 = document.getElementById('cell-8');
    let cellToxic2 = document.getElementById('cell13');
    ...
    function movePlayer(steps) {
      ...
      if (newPosition == 8) {
        ...
        sirene.play();
        //cellToxic1.style.borderColor = "yellow";
        //cellToxic1.style.backgroundImage = "url('../image/explosao.png')";
        //cellToxic1.style.backgroundColor = "red";
